    ...
    <section className="text-gray-600 bg-gray-50  body-font">
      <div className="container px-5 py-12 mx-auto">
        <div className="flex flex-col text-center w-full mb-10">
          ...
          <p className="lg:w-2/3 text-center  mx-auto leading-relaxed text-base">
            أوضح تقرير أمني للنيابة العامة، صدر سنة 2020 عن تعرض 458 ضحية
        ...
        <div className="flex flex-wrap -m-4 text-center">
          <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
            <div className="border-2 bg-white  shadow-md border-gray-200 px-4 py-6 rounded-lg">
              <svg
                fill="none"
                stroke="currentColor"
